...
int main()
{
	...
	Shader baseShader("E:\\opengltst\\oglDemo\\fxaa\\shader\\vertex.glsl", 
		              "E:\\opengltst\\oglDemo\\fxaa\\shader\\fragment.glsl");

	Model baseModel;
	Texture baseTexture("E:\\opengltst\\oglDemo\\fxaa\\texture\\alias.jpg");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1i(glGetUniformLocation(baseShader.program, "textureAA"), 0);
        //glUniform1i(glGetUniformLocation(baseShader.program, "tex0"), 0);

		glUniform2f(glGetUniformLocation(baseShader.program, "iResolution"), 1024, 1024);
		glUniform1i(glGetUniformLocation(baseShader.program, "enabled"), enabled);
